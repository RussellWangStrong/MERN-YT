...
export default function UpdateListing() {
    ...
    useEffect(()=>{
        ...
        // provoke this function when the page render at first
        fetchListing();
        // "[]" means that avoid some duplicated requests
    },[])
    ...
    // sub function of handleImageSubmit()
    ...
    //remove an single img from browser
    ...
    const handleChange = (e) =>{
        ...
        // you can choose multiple options through this condition
    ...
    const handleSubmit = async (e) =>{
      e.preventDefault();
      try {
        if(formData.imageUrls.length < 1) return setError('You must upload at least i image')
        // use "+" to prevent the number attribute to be the string type
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                <p className='font-semiblod'>
                    Images:
                    <span className='font-normal text-gray-600 ml-2'>The first image will be coverd (max 6)</span>
                </p>
                ...
                <div className='flex gap-4'>
                        ...
                        disabled:opacity-80'>{uploading ? 'uploading...':'upload'}
                        </button>
                </div>

                <p className='text-red-300 text-sm'>{imageUploadError && imageUploadError}</p>
